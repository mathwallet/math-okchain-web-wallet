module.exports = {
  ...
  transferring: 'Signing...',
  transfer_same_account: 'Cannot transfer tokens to the same account',
  ledgerLock: 'Please unlock your Ledger Wallet',
  ledger_login: 'Login via Ledger'
}
